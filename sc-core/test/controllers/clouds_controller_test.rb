...
class CloudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cloud" do
    assert_difference('Cloud.count') do
      post clouds_url, params: { cloud: { endpoint: @cloud.endpoint, properties: @cloud.properties, uuid: @cloud.uuid } }
    end
  ...
  test "should update cloud" do
    patch cloud_url(@cloud), params: { cloud: { endpoint: @cloud.endpoint, properties: @cloud.properties, uuid: @cloud.uuid } }
