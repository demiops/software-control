...
class ApikeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apikey" do
    assert_difference('Apikey.count') do
      post apikeys_url, params: { apikey: { key: @apikey.key, secret: @apikey.secret, uuid: @apikey.uuid } }
    end
  ...
  test "should update apikey" do
    patch apikey_url(@apikey), params: { apikey: { key: @apikey.key, secret: @apikey.secret, uuid: @apikey.uuid } }
