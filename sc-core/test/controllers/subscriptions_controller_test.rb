...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { description: @subscription.description, type: @subscription.type, uuid: @subscription.uuid } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { description: @subscription.description, type: @subscription.type, uuid: @subscription.uuid } }
